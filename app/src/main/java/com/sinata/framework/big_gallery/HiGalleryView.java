...
public class HiGalleryView extends HiHoverImageView implements IHiGallery{
    private HiGalleryInfo hiGalleryInfo;
    private float radius = 10;

    public HiGalleryView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        setup(attrs);
    }

    public HiGalleryView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setup(attrs);
    }

    public HiGalleryView(Context context) {
        super(context);
    }
    ...
    @Override
    public void setHiGalleryInfo(HiGalleryInfo hiGalleryInfo) {
        this.hiGalleryInfo = hiGalleryInfo;
    }


    public HiGalleryInfo getHiGalleryInfo(){
        return hiGalleryInfo;
    }

    @Override
    public void startAnimationClickChange(Point centerP, int radius) {
