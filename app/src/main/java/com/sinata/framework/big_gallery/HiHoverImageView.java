...
class HiHoverImageView extends AppCompatImageView {
    ...
    public HiHoverImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        setup(attrs);
    }

    public HiHoverImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setup(attrs);
    }

    public HiHoverImageView(Context context) {
        super(context);
        setup(null);
    }
